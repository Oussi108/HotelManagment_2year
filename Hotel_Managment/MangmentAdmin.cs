    ...
    public partial class MangmentAdmin : UserControl
    {
        ...
        private void guna2Button2_Click(object sender, EventArgs e)
        {
            ...
            d.Img = filePath;
                ...
                db.Foods.InsertOnSubmit(d);
                MessageBox.Show("add succesfuly", "Validation");
                db.SubmitChanges();
            }
        ...
        private void guna2Button4_Click(object sender, EventArgs e)
        {
                ...
                )
            {
                ...
                {
                    db.Foods.DeleteOnSubmit(d);
                }
                db.SubmitChanges();
                MessageBox.Show("deleted succesfuly", "Validation");
        ...
        private void guna2Button3_Click(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(guna2TextBox1.Text, out i))
            {
                ...
                MessageBox.Show("edit succesfuly", "Validation");
                db.SubmitChanges();
        ...
        private void guna2Button5_Click(object sender, EventArgs e)
        {
            ...
            if (guna2TextBox5.Text != "" &&
               ...
               int.TryParse(guna2TextBox6.Text,out test)
               )
            {
        ...
        {
            int i;
            if (int.TryParse(guna2TextBox4.Text, out i))
            {
                ...
                foreach (var d in req)
                {
                    int c = 0;
                    if (guna2TextBox5.Text != "" &&
                     int.TryParse(guna2TextBox6.Text, out c)
                       )
                    {

                        d.TypeService = guna2TextBox5.Text;
                        d.Price = guna2TextBox6.Text;
                    }
                }
                db.SubmitChanges();
                MessageBox.Show("edit succesfuly", "Validation");
